      ...
      <div className="flex justify-between items-center px-3 py-2 gap-2 @md:gap-3 @lg:gap-4 text-white">
        ...
        {modQuant && (
          <div className="flex items-center gap-2">
            ...
            <p className="text-ls @2xs:text-xl @xs:text-2xl @sm:text-4xl" >{card.quantity}{maxQuant? "/"+maxQuant : ""}</p>
        ...
        <div className="flex flex-col text-center ">
          ...
          <p className="text-xs @sm:text-sm @md:text-md @lg:text-lg text-gray-400">{card.set_name}</p>
          ...
          <p className="text-xs @sm:text-sm @md:text-md @lg:text-lg mt-1">${Number(card.price || 0).toFixed(2)}</p>
        </div>
